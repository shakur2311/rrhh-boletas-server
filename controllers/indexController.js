    ...
    try {
        ...
        if(excelCargado){
            ...
            let transporter = nodemailer.createTransport({
                ...
                pass: 'hwrzfqdzmibkhbyq', // contraseña de aplicaciones generadas en gmail acc
                },
            });
            //
            ...
            for(let i = 0;i<(excelFileSheets.Hoja1).length;i++){
                ...
                if(typeof grati!='undefined'){
                    ingresosArray.push({"texto":"008 GRATIFIC. DIC.","valor":commify(parseFloat(grati).toFixed(2))});
                }
                ...
                if(typeof aguinaldo!='undefined'){
                    ingresosArray.push({"texto":"054 AGUINALDO","valor":commify(parseFloat(aguinaldo).toFixed(2))});
                }
                ...
                if(typeof sudunaccp!='undefined'){
                    egresosArray.push({"texto":"605 SUDUNAC-CP","valor":commify(parseFloat(sudunaccp).toFixed(2))});
                }
                ...
                if(typeof sudunacjc!='undefined'){
                    egresosArray.push({"texto":"705 SUDUNAC-JC","valor":commify(parseFloat(sudunacjc).toFixed(2))});
                }
                ...
                if(typeof afpaporteoblig!='undefined'){
                    egresosArray.push({"texto":"818 APORTE OBLIG.","valor":commify(parseFloat(afpaporteoblig).toFixed(2))});
                }
                ...
                await transporter.sendMail({
                    ...
                    html: `<p>Saludos cordiales <strong>${apenom}</strong> , la Unidad de Recursos Humanos remite la boleta de pago
                    correspondiente al mes de <strong>${mesPago}</strong> 2023.
                    <br> Atentamente, Unidad de Recursos Humanos.</br></p>`,
